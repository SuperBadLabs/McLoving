...
An already active fetch may finish I/O but cannot return success when pending
poison wins before its final availability check. An expired poison caller never
