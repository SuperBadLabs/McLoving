...
active leases and makes unresolved work explicit. Every agent authority token
includes the restore epoch as well as the attempt fence and owner, preventing a
rewound counter from recreating stale authority. Activation is idempotent per
backup identifier, and unused recovery points become stale after the epoch
advances.
