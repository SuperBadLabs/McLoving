...
| State transforms | `MIG-005A` | SERIAL | Corrective audit of the exact admitted case | Reopen the state-transform boundary: the sealed inventory records one retained `build-history` object whose forward and rollback transforms remain unsupported. The private HeMan tree has been located and reproduces source digest `b47cc3e1c19e1d486a2df2fc76343e3031ee370a79564fe88a471adbf6e53107`; secret-scan and seal it, implement both transforms, and complete the case-specific rehearsal before returning to `MIG-007` |
...
1. `MIG-005A` corrective closure — the earlier synthetic fixture did not close
   ...
   source tree is located and digest-matched; secret-scan and seal it, implement
   and verify both directions, and complete the case-specific rehearsal.
