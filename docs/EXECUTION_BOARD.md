...
One pending product dispatch slot is selected. `CI-003` has closed the
independent repository-integrity lane; `EXEC-005` remains the product-critical
selection. `DEPLOY-003` replaced
