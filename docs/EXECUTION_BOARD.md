...
and independently verified as deny-authority shadow eligible. SHADOW-001 is the
active serial ticket; it grants no production authority.

| Slot | Current ticket | Status | Dependency-critical successors |
|---:|---|---|---|
| 1 | `SHADOW-001` | ACTIVE | `CANARY-001`, then `MIG-008` |
