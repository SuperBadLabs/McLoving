...
2. `MIG-007` — active review/merge closure. The owner-private package now
   embeds and verifies those exact bounded objects and receipts: one packaged
