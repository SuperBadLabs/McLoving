...
|---:|---|---|---|
| 1 | `JCOMP-002` | ACTIVE | `JCOMP-001` is verified complete; generalize compilation and independent admission, then `JCOMP-002A` delivers sequential step execution, `JCOMP-002B` delivers contained workspace continuity, and `JCOMP-003` earns the paired execution claim |
...
before the paired campaign. `JCOMP-001` is `DONE`; `JCOMP-002` is `ACTIVE`, and its three successors remain `PENDING`.
...
|---|---|---|---|---|
| Sequential Declarative support | `JCOMP-002` -> `JCOMP-002A` -> `JCOMP-002B` -> `JCOMP-003` | SERIAL | `JCOMP-001` verified complete at `533dbff`; `JCOMP-002` selected after fresh custody and exact-main Foundation/Windows verification | One contract, then compiler/admission, sequential step execution, contained workspace continuity, and paired product execution; one PR per ticket and no production authority |
