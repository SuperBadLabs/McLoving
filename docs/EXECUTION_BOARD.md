...
read/write migration gates, isolated external-input adapter boundary, and
persistent-Windows work. CONSUMER-001, ADMIN-001, and INPUT-001 each have
independent security and executable receipts. Mario's sealed runtime-dependency
