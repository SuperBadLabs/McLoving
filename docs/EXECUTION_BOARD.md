...
| Release provenance | `REL-001` | PARALLEL | Contained builder and reproducibility implementation complete; owner ceremony inputs pending | The isolated builder, SBOM, signing, and verifier contracts are implemented; closure now requires the owner-selected release identity/version/profile and genesis policy, signer identity and custody boundary, and transparency log plus independent audit anchor |
...
1. `REL-001` — the contained builder, SBOM, signing, and verifier implementation
   is complete; final provenance and its successors await the owner-selected
   release identity/version/profile and genesis policy, signer identity and
   custody boundary, and transparency log plus independent audit anchor.
...
isolated builder is complete, and the owner-selected signing and transparency
ceremony is the remaining gate.
