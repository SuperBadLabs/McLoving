...
implemented at head `eb6d5782b93fdeb8a98cef964ade4afbd5df03fa`:
typed connector intent, deployment mapping resolution, frozen-predecessor
binding, fenced durable receipt joins, no-lease reconciliation completion,
redacted API evidence, and the adverse failure matrix pass against real
