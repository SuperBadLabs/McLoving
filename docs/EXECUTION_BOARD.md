...
| W4-C | MIG-004, MIG-005A, MIG-005 | ACTIVE | The versioned mapping catalog is sealed; bidirectional persistent-state transforms are active before shared-library/scripted-boundary work |
