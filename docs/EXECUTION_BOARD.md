...
padded. Every remaining ticket now depends on `DEPLOY-001`, or on `SEC-005`,
`EXEC-005`, `SECRET-002`, or `CASE-001` behind it: the campaign is genuinely
serialized behind the deployment lane. Dispatching anything else would mean
