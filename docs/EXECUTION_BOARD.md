...
| Runtime effect integration | `EXT-002` | ACTIVE | Implementation and effect-free Mario rehearsal pass; exact-head review/CI/merge remain | Exact head `b87609857226fb7a44d124a2f1002f75f4bd22c8` now provides the typed connector-intent path, exact deployment mapping admission, redacted public effect evidence, fenced ambiguity handling, and real-PostgreSQL timeout/substitution/crash/lease/cancellation/reconciliation/zero-duplicate proofs. The owner-only Mario receipt SHA-256 is `44ad8eb55386a38dfbe42a62407fd198b87aac53c9eca709f8a387bb0a81d8c7`; all production/canary/cutover authority flags remain false. |
...
| EXT-002 | ACTIVE | CANARY-000, EXT-001, OBS-001, SHADOW-001 | Integrate the certified effect boundary into the shipped product path described by `docs/architecture/RUNTIME_EFFECT_INTEGRATION_V1.md`. Exact implementation head `b87609857226fb7a44d124a2f1002f75f4bd22c8` now includes the typed connector-intent and execution-spec path, strict deployment-owned mapping ID/digest resolution, immutable prepared/outcome/observation/reconciliation/shadow truth, redacted API evidence digests, digest-pinned services, signed response-substitution denial, and lease/crash/timeout/cancellation/retry/ambiguity reconciliation with exactly one fixture dispatch. The 14-test real-PostgreSQL effect-free Mario rehearsal passed on an internal-only runtime network; result receipt SHA-256 `44ad8eb55386a38dfbe42a62407fd198b87aac53c9eca709f8a387bb0a81d8c7` records all production/canary/cutover authority flags false. Closure now requires only independent exact-head review, protected CI, thread resolution, squash merge, and post-merge protected-main verification. Native process execution remains network/credential/effect denied, and the first production action remains exclusively a separately authorized `CANARY-001` ceremony. |
...
implemented at exact head `b87609857226fb7a44d124a2f1002f75f4bd22c8`:
typed connector intent, deployment mapping resolution, fenced durable receipt
joins, redacted API evidence, and the adverse failure matrix pass against real
PostgreSQL. The effect-free Mario rehearsal also passed with every authority
flag false. `EXT-002` remains active only for exact-head review, protected CI,
merge, and protected-main verification. The current Mario inventory still has
