...
| Runtime effect integration | `EXT-002` | ACTIVE | Implementation passes locally; fresh exact-head Mario/review/CI/merge remain | Implementation head `edc392524a5c229c3e5d2a1462b14d45d4611f27` provides the typed connector-intent path, exact deployment mapping admission, shipped-format downstream digest matching, closed protected-reference validation, all-fence redacted public effect evidence, frozen-predecessor binding, fenced ambiguity handling, no-lease reconciliation receipt completion, and real-PostgreSQL timeout/substitution/crash/lease/cancellation/reconciliation/zero-duplicate proofs. The owner-only Mario receipt SHA-256 `44ad8eb55386a38dfbe42a62407fd198b87aac53c9eca709f8a387bb0a81d8c7` belongs to the earlier 14-test candidate and is not exact-head closure evidence; a fresh 17-test effect-free rehearsal remains required. All production/canary/cutover authority flags remain false. |
...
| EXT-002 | ACTIVE | CANARY-000, EXT-001, OBS-001, SHADOW-001 | Integrate the certified effect boundary into the shipped product path described by `docs/architecture/RUNTIME_EFFECT_INTEGRATION_V1.md`. Implementation head `edc392524a5c229c3e5d2a1462b14d45d4611f27` includes the typed connector-intent and execution-spec path, strict deployment-owned mapping ID/digest resolution, immutable prepared/outcome/observation/reconciliation/shadow truth, shipped-format downstream digest comparison, closed protected-reference validation, all-fence redacted API evidence, digest-pinned services, frozen pre-action predecessor binding, signed response-substitution denial, no-lease receipt completion under explicit reconciliation, and lease/crash/timeout/cancellation/retry/ambiguity handling with exactly one fixture dispatch. The earlier 14-test effect-free Mario receipt SHA-256 `44ad8eb55386a38dfbe42a62407fd198b87aac53c9eca709f8a387bb0a81d8c7` records all production/canary/cutover authority flags false but is not exact-head closure evidence. Closure requires a fresh 17-test Mario rehearsal, independent exact-head review, protected CI, thread resolution, squash merge, and post-merge protected-main verification. Native process execution remains network/credential/effect denied, and the first production action remains exclusively a separately authorized `CANARY-001` ceremony. |
...
implemented at head `edc392524a5c229c3e5d2a1462b14d45d4611f27`:
...
PostgreSQL. The earlier-candidate effect-free Mario rehearsal passed with every
authority flag false but does not satisfy the new exact-head gate. `EXT-002`
remains active for a fresh 17-test Mario rehearsal, exact-head review, protected
CI, merge, and protected-main verification. The current Mario inventory still has
