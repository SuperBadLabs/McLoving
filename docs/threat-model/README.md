...
| TM-007 | Workload escapes process-tree cancellation | Linux process groups; race-free suspended-child assignment to kill-on-close Windows Job Objects; VM boundary for hostile tenants | Destructive Linux and Windows timeout, cancellation, service-crash, and descendant tests | AGENT/WIN | Kernel, Job Object, or container-runtime flaw |
