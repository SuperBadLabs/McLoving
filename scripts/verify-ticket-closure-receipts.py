...
# the ten-round cap: same table, EXPECTED_TABLES does not move.
# 142 -> 143 on 2026-09-11 with `AGENT-012`, filed from PAR-014 review past
# the ten-round cap: same table, EXPECTED_TABLES does not move.
# 143 -> 144 on 2026-09-11 with `CTRL-006`, filed from PAR-014 review past
# the ten-round cap: same table, EXPECTED_TABLES does not move.
MINIMUM_TICKET_ROWS = 145
...
CLOSED_TICKETS = frozenset({
    ...
    "IR-004", "JCOMP-001", "JCOMP-002", "JCOMP-002A", "JCOMP-002B", "JCOMP-002C", "JCOMP-003", "JOBSTATE-001", "MIG-000", "MIG-001", "MIG-002",
    ...
    "PAR-000", "PAR-001", "PAR-004", "PAR-010", "PAR-011", "PAR-012", "PAR-013", "PAR-014", "SECRET-001", "SHADOW-001", "TEST-001", "TRIG-001", "UI-001", "UI-002",
    "UX-001", "UX-002", "WIN-001", "WIN-002", "WIN-003", "WIN-004"
})
