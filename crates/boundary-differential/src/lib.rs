...
pub const EVIDENCE_SHA256: &str =
    "45f4686f4a18940e72ebb4836dcc8b6136634761cb0cd01250e2ed48bdd3320b";
...
const EXPECTED_BOUNDARIES: [(&str, &str, &str); 13] = [
    ...
    (
        ...
        "f20beb032434de570c899fae0a037441585c55b9cf5d6e49f0527ee2c43df361",
    ),
    (
        "SECRET-001",
    ...
    (
        ...
        "1dd847c0a1e77e5bd639baa36593c3c326757a76168985e56892e580449f505b",
    ),
    (
        "OBS-001",
        "mcloving.destination-observer/v1",
        "5b1acdb387ac15380f437692230e2eb9eed0d62718daa8af6eacbf70d30c2570",
    ),
    (
        "DISC-001",
    ...
    (
        "CACHE-001",
        "mcloving.cache/v1",
        "08a2f942e3656f73e3a1595051b7d991566a726c94247a9ff393730172b308bd",
    ),
    (
        "CONSUMER-001",
